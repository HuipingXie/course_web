        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="top:11.5%;">
            <div class="sidebar-sticky">
                <ul class="nav flex-column list-group">
                    ...
                    <li class="nav-item list-group-item">
                        <a class="nav-link active" href="getScore">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <table class="table table-striped table-bordered table-hover" id="example">
                ...
                <c:forEach  items="${recordInfoList}" var="record" varStatus="loop">
                    <tr class="odd gradeX">
                        <td>
                            ${record.timetableInfo.course.courseName}
                        </td>
                        <td>${record.timetableInfo.teacher.name}</td>
                        <td>${record.timetableInfo.courseTime}</td>
                        <td class="center">${record.timetableInfo.classroom}</td>
                        <td class="center">
                            ${record.score}
                        </td>
                    </tr>
