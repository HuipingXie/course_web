<%@ page import="course.datacontainer.TimetableInfo" %><%--
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="top:11.5%;">
            <div class="sidebar-sticky">
                <ul class="nav flex-column list-group">
                    ...
                    <li class="nav-item list-group-item">
                        <a class="nav-link active" href="selectCourses">
            ...
            <table class="table table-striped table-bordered table-hover" id="example">
                ...
                <c:forEach  items="${timetableInfoList}" var="ti" varStatus="loop">
                    <tr class="odd gradeX">
                        ...
                        <td class="center">
                            <button class="btn btn-success select-course">选课</button>
...
<script>
    $(document).ready(function() {
        $('.select-course').click(function () {
            var timetable_id=$(this).next().val();
            $.post("doSelectCourse",{
